// $(document).ready(function() {
    ...
    var topics = ["Bear", "Armadillo", "Rabbit", "Cheetah", "Elephant", "Hawk", "Turtle", "Pig", "Dragon"];
    ...
    //Action item for which "animal button" is being selected.
      $("#animal-btns").on("click", ".animal-btn", function() {
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + animal + "&api_key=QrLSavvlPNMiCWrND7vprKtjOAHwqgep&limit=500";
        ...
        $.ajax({
          ...
          for (var i = 0; i <= 9; i++) {
            if (results[i].rating !== "r" && results[i].rating !== "pg-13") {
              ...
              // displays the rating/image on the DOM
      ...
      // Change image status to/from "Still" & "Animated"
